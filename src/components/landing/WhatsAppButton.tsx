const WhatsAppButton = () => {
  const phoneNumber = "4915563744696";
  ...
  return (
    <a
      ...
      className="fixed bottom-6 left-6 z-40 w-12 h-12 rounded-full bg-[#25D366] shadow-lg flex items-center justify-center hover:scale-110 transition-transform duration-200"
