        ...
        items={[
          {
            ...
            a: "Der Preis hängt von Dauer, Anfahrt und Gästezahl ab, daher gibt es kein Pauschalpaket von der Stange. Schreib mir kurz Datum, Ort und die ungefähre Gästezahl über /demo/kontakt, dann bekommst du binnen 24 Stunden ein konkretes Angebot.",
          },
          {
            q: "Wie läuft die Anfrage ab und wie schnell bekomme ich Antwort?",
            a: "Du schickst mir über /demo/kontakt Datum, Ort und die ungefähre Gästezahl. Ich melde mich innerhalb von 24 Stunden persönlich mit Verfügbarkeit und Angebot zurück.",
          },
          {
