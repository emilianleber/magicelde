      ...
      <div className="relative z-10 container px-6 pt-32 md:pt-40 pb-20 md:pb-28">
        <div className="grid lg:grid-cols-12 gap-x-10 gap-y-12 items-end">
          <div className="lg:col-span-7">
            ...
            {/* CTAs */}
            <div className="mt-10 flex flex-col sm:flex-row items-start sm:items-center gap-4 hero-fade" style={{ animationDelay: "1.3s" }}>
              <Link
                to="/buchung"
                  ...
                  style={{
                    background:
                      cs.tint === "rose"
                        ...
                        : cs.tint === "amber"
                          ? "linear-gradient(180deg, rgba(8,6,12,0.18) 0%, rgba(199,144,66,0.28) 70%, rgba(138,90,20,0.62) 100%)"
