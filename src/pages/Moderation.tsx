/** /moderation — Moderation (kreativ, abwechslungsreich). */
...
export default function Moderation() {
  return (
    <VoltageShell
      title="Moderation mit Magie — Durch den Abend führen | Emilian Leber"
      description="Moderation mit eingebauter Magie für Galaabende, Firmen-Events, Hochzeiten und Award-Shows. Charmant, präzise, mit dem richtigen Ton. TV-erfahren, Magie als Bridge zwischen Programmpunkten."
      path="/moderation"
      noindex={false}
    >
      <SubHero
        ...
        items={[
          {
            ...
            a: "Preislich ist es abhängig von Dauer, Anfahrt und Gästezahl — ein konkretes Angebot bekommst du nach einer kurzen Anfrage. Schreib mir einfach über /kontakt, ich antworte innerhalb von 24 Stunden.",
          },
          {
