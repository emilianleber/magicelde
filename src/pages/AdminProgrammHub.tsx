...
const AdminProgrammHub = () => {
  ...
  const cards = [
    ...
    {
      label: "Musik & Einspieler",
      description: "Musik-Tracks, Einspieler und Soundeffekte verwalten.",
      href: "/admin/programm/musik",
      icon: Sparkles,
      stat: 0,
      statLabel: "Tracks",
      accent: false,
    ...
    {
      label: "Technik-Inventar",
      description: "Equipment, Licht, Ton und Requisiten verwalten.",
      href: "/admin/programm/technik",
      icon: Sparkles,
      stat: 0,
      statLabel: "Gegenstände",
      accent: false,
    },
    {
      label: "Locations",
